...
// handle cors in express https://enable-cors.org/server_expressjs.html
...
// taken from https://create-react-app.dev/docs/deployment
...
app.get('/', (req, res) => {
  res.json({
    message: 'Welcome to the REST API side!',
  });
});
